  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center text-center gap-y-3 py-3">
        ...
        <button
          className="lg:w-[200px] md:w-[180px] sm:w-[170px] xsm:w-[150px] xxs:w-[140px] text-[#0064B0]  md:h-[60px] xsm:h-[55px] xxs:h-[50px] rounded-[6px] border-[2px] flex justify-center items-center  border-[#1255A1]  hover:bg-[#1255A1]
           hover:text-white transition-all duration-[600ms] ease-in-out cursor-pointer tracking-normal font-[700]  leading-[24.38px] xsm:text-[14px] xxs:text-[12px] "
        >
          Consult Our Experts
        </button>
      </div>
